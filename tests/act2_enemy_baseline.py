"""Capture once, or restore, the working tree before the Act 2 enemy pass."""
...
archive=ROOT/'tests/fixtures/act2_enemies_before.zip'
dest=(ROOT/'tmp/act2_enemies/before').resolve()
...
print('Captured/verified Act 2 enemy baseline:',len(hashes),'source files')
