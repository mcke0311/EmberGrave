"""Capture/restore the exact pre-threshold source tree without checking out files."""
from pathlib import Path
import hashlib, json, zipfile
ROOT = Path(__file__).resolve().parents[1]
archive = ROOT / 'tests/fixtures/act2_thresholds_before.zip'
dest = ROOT / 'tmp/act2_thresholds/before'
...
print('Verified threshold baseline:', len(hashes), 'files')
