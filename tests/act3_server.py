...
Run from the project root: python tests/act3_server.py
"""
...
class ReviewHandler(NoCacheHandler):
    ...
    def do_POST(self):
        ...
        try:
            ...
            directory = Path(ROOT) / 'tests/qa/act3'
...
if __name__ == '__main__':
    server = http.server.ThreadingHTTPServer(('127.0.0.1', 8743), ReviewHandler)
    print('Act III review: http://localhost:8743/tests/act3_review.html', flush=True)
    try:
