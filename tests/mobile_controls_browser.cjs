...
(async()=>{
  ...
  try {
    ...
    await page.locator('#panelRight .pclose').tap();
    ...
    await page.locator('#panelLeft .pclose').tap();
    ...
    ok(panel.y>=0&&panel.y+panel.height<=390,'landscape panel is clipped');await page.locator('#panelLeft .pclose').tap();
