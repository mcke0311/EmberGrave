"""Restore the captured pre-Act-3 working tree into ignored review storage.

The archive includes the uncommitted Act 1 and other work present when Act 2 began.
...
archive=ROOT/'tests/fixtures/act3_before.zip'
dest=(ROOT/'tmp/act3/before').resolve()
...
print('Verified/restored pre-Act-3 working snapshot:',len(hashes),'files')
