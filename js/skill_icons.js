...
const SkillIcons = (() => {
  ...
  const themes = {
    ...
    veilranger: [["gold", "Mark your quarry and make every arrow count."], ["steel", "Set the killing ground before the fight begins."], ["hex", "Expose an opening. Strike from shadow."]],
  ...
  const glyphs = {
    dagger: path("M29 43 31 11 37 5 41 13 35 44Z M23 40 43 43 42 47 22 44Z") + line("M29 46 28 56"),
    fan: path("M27 49 10 16 19 12 31 45Z M30 45 29 8 38 8 35 45Z M36 46 46 13 55 18 40 50Z"),
    ...
    net: line("M10 22 32 9 54 22 49 46 32 54 15 46Z M16 18 45 48 M24 13 51 39 M10 29 34 53 M48 18 19 48 M40 13 13 39 M54 29 30 53"),
  ...
  const assignments = {
    ...
    veilranger_0_4: "ricochet steel", veilranger_0_5: "claw blood mastery", veilranger_0_6: "rain gold",
    veilranger_1_0: "trap steel", veilranger_1_1: "gear steel mastery", veilranger_1_2: "trap cold frost", veilranger_1_3: "net steel ring",
    veilranger_1_4: "caltrops steel ring", veilranger_1_5: "trap fire fire", veilranger_1_6: "eye blood mastery",
    veilranger_2_0: "boot hex morph", veilranger_2_1: "dagger hex target", veilranger_2_2: "boot hex mastery", veilranger_2_3: "cleave hex burst",
    veilranger_2_4: "skull hex target", veilranger_2_5: "fan hex speed", veilranger_2_6: "sword hex target",
    ...
    kinship: "paw nature heal", feral_howl: "wolf nature burst", wildkeeper_0_6: "golem nature summon",
  ...
  const roles = { passive: "Passive", summon: "Summon", summon_golem: "Summon", form: "Transformation", trap: "Trap", dragnet: "Crowd control", tripwire: "Trap",
